...
extern void PathPartInsert(const char *F,char *Insert);
extern void DrivePartInsert(const char *F,char *Insert);
extern char * PathPart_Static(char *FName);
extern char * DrivePart_Static(char *FName);
...
{
    //wchar_t w_name[ 1024 ];	// file name
    char a_name[ 1024 ];	// file name
};
