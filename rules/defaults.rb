...
def set_defaults
	...
	# Array of Strings, paths to header files that should be precompiled.
	...
	# Hash(String,Task). Key is the filename of a source file.
	# Value is a Task that's a prerequisite for compiling that file.
	default(:SPECIFIC_PREREQUISITES, {})
	...
	default(:COMMON_BASEDIR, File.expand_path_fix('.'))
